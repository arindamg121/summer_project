...
namespace KnowYourResult
{
    public partial class sem1AN : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            mycon.Open();
            OleDbCommand cmd = new OleDbCommand("select * from [shift22$a4:be]", mycon);
        ...
        {
            String query = "insert into sem1A values('" + seatno1 + "','" + sname1 + "','" + oopt1 + "','" + oopi1 + "','" + oopt1 + "','" + oopc1 + "','" + oopg1 + "','" + oopgp1 + "','" + oopcgp1 + "','" + sepmt1 + "','" + sepmi1 + "','" + sepmto1 + "','" + sepmc1 + "','" + sepmg1 + "','" + sepmgp1 + "','" + sepmcgp1 + "','" + coat1 + "','" + coai1 + "','" + coato1 + "','" + coac1 + "','" + coag1 + "','" + coagp1 + "','" + coacgp1 + "','" + itmt1 + "','" + itmi1 + "','" + itmto1 + "','" + itmc1 + "','" + itmg1 + "','" + itmgp1 + "','" + itmcgp1 + "','" + spt1 + "','" + spi1 + "','" + spto1 + "','" + spc1 + "','" + spg1 + "','" + spgp1 + "','" + spcgp1 + "','" + lab11 + "','" + lab21 + "','" + labp1 + "','" + labpt1 + "','" + labpc1 + "','" + labpg1 + "','" + labpgp1 + "','" + labpcgp1 + "','" + lab31 + "','" + lab41 + "','" + mini1 + "','" + minit1 + "','" + minic1 + "','" + minig1 + "','" + minigp1 + "','" + minicgp1 + "','" + g1 + "','" + gpa1 + "','" + grade1 + "','" + result1 + "','" + batch + "')";
            String mycon = "Data Source=REIGNZ\\SQLEXPRESS; Initial Catalog=StudentDetail; Integrated Security=True";
