...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Shift :"></asp:Label>
...
&nbsp;
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Batch :"></asp:Label>
     ...
     <asp:listitem Text="2020"></asp:listitem>
        ...
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Subject Grade:"></asp:Label>
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Display" />
        <br />
        <br />
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="Passed/Failed:"></asp:Label>
