...
message = tk.Label(window, text="Vivekanand Education Society's Institute Of Technology",bg="#FF9A8C",fg="black",width=45,height=1,font=('Times New Roman', 35, 'bold underline'))
...
lbl2 = tk.Label(window,text="Enter Your Name",width=20,fg="black",bg="#FF9A8C",height=2,font=('Times New Roman',25,'bold'))
...
takeImg = tk.Button(window,text="Image Capture Button",command=TakeImages,fg="white",bg="blue",width=25,height=2,activebackground = "#FF9A8C",font=('Times New Roman',15,'bold'))
takeImg.place(x=245-x_cord,y=425-y_cord)
trainImg = tk.Button(window,text="Model Training Button",command=TrainImages,fg="white",bg="blue",width=25,height=2,activebackground = "#FF9A8C",font=('Times New Roman',15,'bold'))
